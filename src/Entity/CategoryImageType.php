 ...
 *
 * The need to create it was that this information is very specific to Category
 ...
 */
#[ORM\Entity(repositoryClass: CategoryImageTypeRepository::class)]
class CategoryImageType
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
